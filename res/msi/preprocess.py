...
def make_parser():
    ...
    parser.add_argument(
        "--app-name", type=str, default="DarkControl", help="The app name."
    )
    parser.add_argument(
...
def update_license_file(app_name):
    ...
    license_content = re.sub("Dark Control", app_name, license_content, flags=re.IGNORECASE)
